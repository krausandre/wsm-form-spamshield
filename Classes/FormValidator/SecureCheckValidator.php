...
class SecureCheckValidator extends AbstractValidator
{
    ...
    protected function isValid($value)
    {
        ...
        if (!$this->checkMinimumInfos($securityChecks)) return false;
    ...
    protected function checkMinimumInfos(array $checks): bool
    {
        ...
        $minimValues = ['seconds','displayWidth', 'displayHight', 'formRenderedHight', 'formRenderedWidth'];
    ...
    protected function validateCheck(string $key, int $check): bool
    {
        ...
        if ($key === 'formRenderedHight' && $check > 20) {
